...
namespace TerminvereinbarungWebApp.Controllers
{
    public class UsersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Vorname,Nachname,Geburtsdatum,Telefon,EMail,Krankenkasse,Arzt,Admin,Passwort")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Vorname,Nachname,Geburtsdatum,Telefon,EMail,Krankenkasse,Arzt,Admin,Passwort")] User user)
        {
            if (ModelState.IsValid)
            {
